...
import { expenseApi, categoriesApi, Expense, Category } from '../api/services'
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h2 className="text-3xl font-bold bg-gradient-to-r from-purple-600 to-indigo-600 bg-clip-text text-transparent">จัดการรายจ่าย</h2>
        <button
          onClick={() => {
            resetForm()
            setEditingExpense(null)
      ...
      <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg border border-purple-100 overflow-hidden">
        {loading ? (
          ...
          <div className="p-8 text-center text-gray-500">ไม่มีข้อมูลรายจ่าย</div>
        ) : (
      ...
      >
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex justify-end space-x-3 pt-4">
            ...
            >
              {editingExpense ? 'บันทึกการแก้ไข' : 'เพิ่มรายจ่าย'}
            </button>
          </div>
        </form>
      </Modal>
